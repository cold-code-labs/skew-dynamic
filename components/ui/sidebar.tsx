...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: as a flex child of the sidebar row, the default min-width:auto
        // lets wide content (tables, <pre>, long strings) push the whole page
        // sideways. min-w-0 lets the content column shrink so the *element*
